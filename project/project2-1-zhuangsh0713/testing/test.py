...
tests = [
    ("Testcase 1 (all CI and CR type)", "student_output/proj_2_1_test.out",TestCase(os.path.join(file_locations,'circ_files/proj_2_1_test.circ'), os.path.join
(file_locations,'reference_output/proj_2_1_test.out'), ""))
]
